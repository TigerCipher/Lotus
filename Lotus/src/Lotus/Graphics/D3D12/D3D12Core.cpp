...
namespace lotus::graphics::d3d12::core {namespace
    {
    class d3d12_command
    {
    public:
...
void deferred_release(IUnknown* resource)
{
    ...
    bool initialize()
    {
        ...
        #ifdef L_DEBUG
        {
            ...
            {
                OutputDebugStringA("Warning: D3D12 Debug interface not available. Optional feature \"Graphics Tools\" should be installed on this device.");
            }
